		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<div id="header">
					<p>
						<xsl:choose>
							<xsl:when test="sitemap:sitemapindex">This XML Sitemap Index is generated by WordPress to make your content more visible for search engines. </xsl:when>
							<xsl:otherwise>This XML Sitemap is generated by WordPress to make your content more visible for search engines. </xsl:otherwise>
						</xsl:choose>
