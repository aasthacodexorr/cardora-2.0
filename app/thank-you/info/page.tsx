...
function InfoContent() {
  ...
  return (
    <main className="mt-20 font-sans text-gray-800 bg-white">
      ...
      <section className="max-w-[1550px] mx-auto px-7 py-12 md:pb-20 md:pl-32">
      ...
      <section className="bg-white max-w-[1250px] mx-auto px-7 pt-12 md:pt-20">
      ...
      <section className="py-16 md:py-20 bg-hero-bg">
        <div className="max-w-6xl mx-auto text-start px-7">
      ...
      <section className="mx-auto px-7 md:px-44 pt-14 pb-10 bg-light-gray">
        {/* Section Header */}
