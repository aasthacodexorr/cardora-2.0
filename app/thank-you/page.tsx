        ...
        <>
            <Header />
             <div className='lg:mt-20 pt-14 lg:pt-28 lg:pb-20 px-4 pb-10 lg:px-44 w-full flex flex-col justify-center items-center gap-2 bg-gradient-to-b from-prequalify-blue to-white'>
                ...
                <div className='mt-8'>
                  <Link href={"/"} className='text-white cursor-pointer text-base w-full hover:opacity-90 transition-opacity rounded-[12px] py-3 px-[30px] block text-center bg-brand'>
