        ...
        <>
            <Header />
             <div className='bg-gradient-to-b from-[#e6f4ff] to-white lg:mt-20 pt-14 lg:pt-28 lg:pb-20 px-4 pb-10    lg:px-44 w-full flex flex-col justify-center items-center gap-2'>
                ...
                <div className='mt-8'><button className='text-white cursor-pointer text-base w-full hover:opacity-90 transition-opacity rounded-[12px] py-3 px-[30px] bg-gradient-to-b from-[#00af66] to-[#00af66a6]'>Go Back to Home Page</button></div>
            </div>
