...
import AppointmentLink from '@/components/service/AppointmentLink';
    ...
    <div className="min-h-screen font-sans bg-white antialiased">
            ...
            <div className="lg:col-span-6 flex justify-center lg:justify-end">
              ...
              <div className="relative w-full max-w-[500px] bg-white p-6 pt-10 rounded-xl shadow-md border-2 border-dashed border-brand2">
                ...
                <div className="flex flex-col lg:flex-row lg:justify-start lg:items-start justify-center items-center gap-3 mt-14">
                  <AppointmentLink className="flex items-center w-full lg:w-fit justify-center hover:brightness-95 text-white font-medium py-3 px-6 rounded-xl transition duration-200 text-center text-xs md:text-sm shadow-sm bg-brand-btn-gradient border border-brand">
                    Schedule Service
                  </AppointmentLink>
      ...
      <section className="w-full border-t border-slate-100 py-8 text-center bg-review-blue">
        <div className="max-w-4xl mx-auto px-6 md:px-12 py-5 md:py-10 space-y-3">
          ...
          <div>
            <AppointmentLink className="inline-block py-3 px-10 mt-4 rounded-lg transition duration-200 text-xs md:text-lg bg-brand-green-alpha text-white border border-brand2 hover:brightness-90 hover:text-white"
            >
              Schedule Service
            </AppointmentLink>
          </div>
