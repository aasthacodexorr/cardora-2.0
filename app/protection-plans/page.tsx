  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="w-full bg-[#e6f4ff] border-t border-neutral-100/60 py-16 md:py-20 mt-20">
        <div className="mx-auto max-w-[1400px] px-6 flex flex-col items-center text-center">
        ...
        <div className="mx-auto  px-14">
          ...
          <div className="mt-10 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2">
            {coveredSystems.map(({ icon: Icon, label }) => (
              <div key={label} className="w-full bg-card border border-[#00b066] rounded-xl hover:bg-[#00af66a6] text-[#00b066] hover:text-white cursor-pointer px-6 py-3 flex items-center justify-center gap-3 transition-all">
          ...
          <div className="mt-7 grid md:grid-cols-2 gap-7">
            {includedFeatures.map(({ icon: Icon, title, body }) => (
              <div key={title} className="rounded-2xl py-2 transition-all flex justify-start items-start gap-4">
                <div className="max-h-8 max-w-8 p-1 rounded-full bg-brand-green flex items-center justify-center">
      ...
      {/*  GAP Coverage */}
      <section className="bg-white text-gray-900 pt-18 px-4 font-sans">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="mt-4 text-base mx-auto leading-relaxed">
