            ...
            <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-8">
              ...
              <aside className="rounded-[2.5rem] bg-white shadow-[0_4px_20px_rgb(0,0,0,0.03)] p-6 h-fit">
                <div className="mb-6 flex flex-col items-center gap-4">
                  ...
                  <ClearRefinements
                    classNames={{
                      button: "text-[13px] font-bold text-gray-800 hover:text-[#00A651] disabled:opacity-50 disabled:cursor-not-allowed",
                    }}
                    translations={{
                  ...
                  <FilterGroup title="PRICE">
                    <RangeInput
                      ...
                      classNames={{
                        ...
                        input: "w-full px-3 py-2.5 rounded-xl border border-gray-200 bg-white text-[14px] outline-none focus:border-brand-green focus:ring-1 focus:ring-brand-green text-gray-900 transition-all",
                        submit: "hidden",
                  ...
                  <div className="relative w-full md:max-w-md">
                    <SearchBox
                      classNames={{
                        ...
                        input: "w-full pl-12 pr-4 py-3.5 rounded-[1rem] border-0 shadow-sm bg-white text-[15px] outline-none focus:ring-2 focus:ring-brand-green transition-all",
                        submitIcon: "hidden",
                        resetIcon: "hidden",
                      }}
                ...
                <div className="mb-6">
                  <CurrentRefinements 
                    classNames={{
                      ...
                      label: "hidden",
                      category: "flex items-center bg-white rounded-lg px-4 py-2 shadow-sm border border-gray-200 text-[14px] text-gray-700",
                      categoryLabel: "mr-3",
                      delete: "text-gray-500 hover:text-gray-900 focus:outline-none flex items-center justify-center text-[16px]",
                    }}
                  />
                </div>
...
const Inventory = () => {
  return (
    <Suspense fallback={<div className="min-h-screen bg-background flex items-center justify-center font-bold">Loading inventory...</div>}>
      <InventoryContent />
    </Suspense>
  );
};
