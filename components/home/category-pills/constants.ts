...
export const CATEGORIES: Category[] = [
  { label: "EVs",         icon: faBolt,       queryParams: "fuel_type=" + encodeURIComponent("Electric") },
  { label: "Sedans",      icon: faCar,        queryParams: "body_type=" + encodeURIComponent("Sedan|Sedan 4 Dr.") },
  { label: "Used",        icon: faCar,        queryParams: "" },
  { label: "Vans",        icon: faVanShuttle, queryParams: "body_type=" + encodeURIComponent("Van|Passenger Van|Cargo Van") },
  { label: "SUVs",        icon: faCarSide,    queryParams: "body_type=" + encodeURIComponent("SUV|Sport Utility") },
  { label: "Hybrids",                         queryParams: "fuel_type=" + encodeURIComponent("Hybrid") },
  { label: "Below $20k",  icon: faPiggyBank,  queryParams: "price=" + encodeURIComponent("0:20000") },
];
