...
export const servicesData: Record<string, ServiceContent> = {
  "oil-change": {
    ...
    introText1: "Keep your engine running smoothly with professional oil change at Cardora in Brampton. Whether you drive daily through city traffic, commute on the highway, or deal with tough Ontario winters, regular oil changes help protect your engine, improve fuel efficiency, and extend the life of your vehicle.",
    introText2: "At Cardora, our experienced technicians provide quick, reliable oil changes using high-quality oil and filters designed for your vehicle’s needs. We make maintenance simple, transparent, and stress-free.",
    introText3: "",
    ...
    faqs: [
      ...
      { q: "What type of oil does Cardora use?", a: "We use premium synthetic oil designed to provide better engine protection, improved performance, and longer-lasting durability for modern vehicles." },
      ...
      { q: "Do you replace the oil filter during every oil change?", a: "Yes. Every oil change service at Cardora includes a new oil filter replacement to help maintain proper engine protection and oil flow." },
      { q: "Why choose Cardora for an oil change in Brampton?", a: "Drivers across Brampton choose Cardora for fast service, experienced technicians, premium synthetic oil, honest recommendations, and a customer-focused experience." }
    ]
  },
  "brakes": {
    id: "brakes",
    cityTitle: "Brake Repair & Brake Service in Brampton, ON",
    ...
    bannerChecklist: [
      ...
      "Expert Installation by Cardora Certified Technicians",
      "Valid for Most Cars, SUVs & Light Trucks",
      "Reliable Braking Performance You Can Trust at Cardora"
    ],
    introText1: "Your brakes are one of the most important safety systems in your vehicle. At Cardora in Brampton, we provide professional brake inspections, brake pad replacements, rotor service, and complete brake repairs to help keep you safe on the road.",
    ...
    signsListBody1: "Ontario driving conditions can put extra stress on your braking system, especially during winter months and stop-and-go city traffic around Brampton and the GTA.",
  ...
  "tire-service": {
    id: "tire-service",
    cityTitle: "Tire Service in Brampton, ON",
    ...
    bannerChecklist: [
      ...
      "Expert Installation by Cardora Certified Technicians",
      "Valid for Most Cars, SUVs & Light Trucks",
      "Reliable Tire Performance & Safer Driving at Cardora"
    ],
    ...
    introText2: "At Cardora in Brampton, we provide complete tire services including tire replacement, tire rotations, balancing, seasonal tire swaps, flat tire repairs, and inspections.",
    ...
    faqs: [
      ...
      { q: "Why choose Cardora for tire service in Brampton?", a: "Drivers throughout Brampton trust Cardora for reliable tire services, seasonal tire swaps, experienced technicians, and honest customer care." }
    ],
    // Added missing keys
    section2LastBody1: "",
    section2LastBody2: "",
  ...
  "wheel-service": {
    ...
    bannerChecklist: [
      ...
      "Performed by Cardora Certified Technicians",
      "Valid for Most Cars, SUVs & Light Trucks",
      "Improved Handling, Tire Life & Driving Comfort at Cardora"
    ],
    ...
    introText2: "At Cardora in Brampton, we provide professional wheel alignment services to help improve handling, protect your tires, and create a smoother driving experience.",
    ...
    faqs: [
      ...
      { q: "Why choose Cardora for wheel alignment in Brampton?", a: "Drivers across Brampton trust Cardora for accurate wheel alignment services, experienced technicians, honest recommendations, and reliable customer care." }
    ],
    // Added missing keys
    section2LastBody1: "",
    section2LastBody2: "",
  ...
  "battery": {
    ...
    introText1: "Ensure reliable engine starts with professional battery service at Cardora in Brampton. We provide expert battery testing, replacement, and maintenance to keep your vehicle running strong in any weather condition.",
    introText2: "",
    introText3: "",
