  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        carmax: ["Carmax Variable", "sans-serif"], // custom font
      },
      ...
      colors: {
        ...
        "search-panel": "hsl(var(--search-panel))",
        "result-bg": "hsl(var(--result-bg))",
        "review-bg": "hsl(var(--review-bg))",
        "diff-card": "hsl(var(--diff-card))",
        "price-green": "hsl(var(--price-green))",
        "review-avatar": "hsl(var(--review-avatar))",
        "review-name": "hsl(var(--review-name))",
        star: "hsl(var(--star))",
        "dark-section": {
